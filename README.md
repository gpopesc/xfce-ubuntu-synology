...
# Full installation in docker of a ubuntu container with Xfce desktop with sound (only in linux)

it needs about 350-450Mb RAM when running (more with firefox or chrome).
...
*Method 2: install from docker CLI* - less recommended -
